...
export const Route = createFileRoute("/splash")({
  head: () => ({
    meta: [
      { title: "Welcome to Hivision Academy" },
      { name: "description", content: "Hivision Academy is loading your learning journey." },
      { property: "og:title", content: "Welcome to Hivision Academy" },
      { property: "og:description", content: "Hivision Academy is loading your learning journey." },
    ],
  }),
  component: Splash,
});
  ...
  return (
    <div className="grid min-h-screen place-items-center px-6 text-primary-foreground [background:var(--gradient-hero)]">
      <div className="bounce-in flex flex-col items-center text-center">
        ...
        <h1 className="mt-6 text-4xl">Hivision Academy</h1>
